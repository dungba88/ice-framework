function Popup(){
    ...
    this.error = function(msg){
    	this.add('popup-error', '<img src="static/css/beta/images/icon/24/error24.png" alt="error"/>Có lỗi', '<div class="popup-error">'+msg+'</div>\
			<div class="popup-toolbar-msg"><a class="button" onclick="generateEvent(\'PopupRemove\', {id: \'popup-error\'})">Đồng ý</a></div>\
    	');
    }
    
    this.msg = function(msg){
    	this.add('popup-msg', '<img src="static/css/beta/images/icon/24/info24.png" alt="info"/>Thông báo', '<div class="popup-msg">'+msg+'</div>\
