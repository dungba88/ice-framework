TopicCreatePortletStandalone = TopicCreatePortlet.extend({
	...
	onShowTopicCreatePopup: function(eventData)	{
		...
		subject.notifyEvent('ShowPopup', {id: 'TopicCreatePortletStandalone', 'title': '<img alt="add" src="static/css/beta/images/icon/24/add24.png" />Thêm chủ đề mới', 'content': this.template.html()});
	},
