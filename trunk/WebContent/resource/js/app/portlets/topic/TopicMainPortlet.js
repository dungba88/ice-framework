TopicMainPortlet = Class.extend({
	...
	run: function()	{
		...
		this.onAjax('catchword', 'get-topic-details', {'id':id}, 'GET', {
			'onSuccess': function(ret)	{
				...
				if (ret.avatar == undefined || ret.avatar == '')	{
					ret.avatar = 'bkprofile.png';
				}
				obj.requestForEffectiveResource('TopicAvatar').attr('src', 'static/images/topics/'+ret.avatar);
			},
		...
		this.onAjax('ajax', 'get-topic-stats', {'id':id}, 'GET', {
			'onSuccess': function(ret)	{
